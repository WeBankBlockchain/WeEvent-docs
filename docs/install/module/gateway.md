...
从`github`下载安装包[weevent-gateway-1.6.0.tar.gz](https://github.com/WeBankBlockchain/WeEvent/releases/download/v1.6.0/weevent-gateway-1.6.0.tar.gz)，并且解压到`/usr/local/weevent/`下。
