...
从`github`下载安装包[weevent-broker-1.5.0.tar.gz](https://github.com/WeBankFinTech/WeEvent/releases/download/v1.5.0/weevent-broker-1.5.0.tar.gz)，并且解压到`/usr/local/weevent/`下。

``` shell
$ cd /usr/local/weevent/
$ wget https://github.com/WeBankFinTech/WeEvent/releases/download/v1.5.0/weevent-broker-1.5.0.tar.gz
$ tar -zxf weevent-broker-1.5.0.tar.gz
```
如果`github`下载速度慢，可以尝试[国内下载链接](https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/WeEvent/download/releases/v1.5.0/weevent-broker-1.5.0.tar.gz)。

解压后的目录如下：

```
$ cd ./weevent-broker-1.5.0
$ tree  -L 1
.
|-- apps
|-- broker.sh
...
- 区块链FISCO-BCOS节点
  ...
  - 访问节点的证书文件
    ...
    证书文件生成及获取请参见[FISCO-BCOS 2.x安装](https://fisco-bcos-documentation.readthedocs.io/zh_CN/latest/docs/tutorial/installation.html)
