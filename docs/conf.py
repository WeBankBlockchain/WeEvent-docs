...
htmlhelp_basename = 'WeEvent_DOCS'
...
man_pages = [
    (master_doc, 'WeEvent', u'WeEvent Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'WeEvent', u'WeEvent Documentation',
   author, 'WeEvent-DEV', 'documents of WeEvent',
   'Miscellaneous'),
]
